...
// Using GPT-5-mini for optimal cost/performance
...
// Using GPT-5-mini: OpenAI's latest compact reasoning model (Aug 2025)
// - Strong reasoning capabilities for market analysis
// - Cost-effective and fast
// - Perfect for SmartTrading Logic v2

const MODEL = "gpt-5-mini";

console.log(`🤖 Using OpenAI GPT-5-mini for market analysis`);
...
async function getAiMarketInsight(data) {
  try {
    ...
    console.log(`🤖 Calling OpenAI GPT-5-mini with SmartTrading Logic v2...`);
    ...
    const response = await openai.chat.completions.create({
      ...
      max_completion_tokens: 2500  // GPT-5-mini uses max_completion_tokens
